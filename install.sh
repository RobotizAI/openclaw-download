...
main() {
  ...
  echo ""
  echo "🤖 Comandos úteis:"
  echo "  openclaw onboard -> Configurações iniciais do openclaw"
  ...
  echo ""
  echo "👉 Próximo comando, digite:"
  echo "  openclaw onboard"
  echo ""
  echo "👉 Depois que concluir as configurações inicias (com openclaw onboard) atualize a página do Openclaw (apertando Ctrl + F5) ou digite o comando:"
